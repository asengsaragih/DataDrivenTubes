...
public class CursorMainUtangAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        TextView tanggalPeminjamanTitle = view.findViewById(R.id.textView4);
        TextView jatuhTempoTitle = view.findViewById(R.id.textView5);
        ImageView warningIamgeView = view.findViewById(R.id.imageView_list_warning);
...
//                mainConstraint.setBackgroundResource(R.color.white);
                warningIamgeView.setVisibility(View.VISIBLE);

                namaTextView.setTextColor(Color.parseColor("#000000"));
                tanggalPeminjamanTextView.setTextColor(Color.parseColor("#797575"));
                jumlahTextView.setTextColor(Color.parseColor("#797575"));
                tanggalPeminjamanTitle.setTextColor(Color.parseColor("#797575"));
            }
        }
        ...
        if (TextUtils.isEmpty(jatuhTempoString)) {
            jatuhTempoTextView.setText(": - ");
        } else {
            jatuhTempoTextView.setText(": " + methodeFunction.subStringTanggal(jatuhTempoString));
        }

        namaTextView.setText(cursor.getString(cursor.getColumnIndex(Contract.UtangEntry.COLUMN_UTANG_NAMA)));
        tanggalPeminjamanTextView.setText(": " + methodeFunction.subStringTanggal(tanggalPeminjamanString));
